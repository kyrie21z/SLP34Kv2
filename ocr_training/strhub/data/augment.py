...
def rand_augment_transform(magnitude=5, num_layers=3):
    ...
    # Fix for timm >= 1.0: use keyword arguments and pass transforms as list
    ra_ops = auto_augment.rand_augment_ops(magnitude=magnitude, hparams=hparams, transforms=_RAND_TRANSFORMS)
